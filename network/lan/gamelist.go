...
func (g *MDNSGameList) service() string {
	return strings.ToLower(fmt.Sprintf("_%s%x._sub._blizzard._udp.local.", g.GameVersion.Product.String(), g.GameVersion.Version))
}
	...
	var msg = dns.Msg{
		Question: []dns.Question{
			dns.Question{
				...
				// In the Question Section of a Multicast DNS query, the top bit of the qclass field
				// indicates that unicast responses are preferred for this particular question
