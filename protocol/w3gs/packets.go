...
// Serialize encodes the struct into its binary form.
func (pkt *Pong) Serialize(buf *protocol.Buffer) error {
	var start = buf.Size()
...
// Serialize encodes the struct into its binary form.
func (pkt *PeerPing) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *PeerPing) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *PeerPong) Serialize(buf *protocol.Buffer) error {
	var start = buf.Size()
	if err := pkt.Ping.Serialize(buf); err != nil {
		return err
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *Join) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *Join) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *RejectJoin) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *RejectJoin) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 8 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *SlotInfoJoin) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
	buf.WriteUInt8(PidSlotInfoJoin)
	buf.WriteUInt16(uint16(30 + len(pkt.Slots)*9))

	pkt.SlotInfo.SerializeContent(buf)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *SlotInfoJoin) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 30 {
		return ErrInvalidPacketSize
	}

	if err := pkt.SlotInfo.DeserializeContent(buf); err != nil {
		return err
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *SlotInfo) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
	buf.WriteUInt8(PidSlotInfo)
	buf.WriteUInt16(uint16(13 + len(pkt.Slots)*9))

	pkt.SerializeContent(buf)

	return nil
}

// Deserialize decodes the binary data generated by Serialize.
func (pkt *SlotInfo) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 13 {
		return ErrInvalidPacketSize
	}

	if err := pkt.DeserializeContent(buf); err != nil {
		return err
	}
...
func (pkt *SlotInfo) SerializeContent(buf *protocol.Buffer) {
...
func (pkt *SlotInfo) DeserializeContent(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *PlayerInfo) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *PlayerInfo) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 43 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *Leave) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *Leave) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 8 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *PlayerKicked) Serialize(buf *protocol.Buffer) error {
	var start = buf.Size()
...
// Serialize encodes the struct into its binary form.
func (pkt *LeaveAck) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *LeaveAck) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *PlayerLeft) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *PlayerLeft) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *CountDownStart) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *CountDownStart) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 4 {
		return ErrInvalidPacketSize
	}
	return nil
...
// Serialize encodes the struct into its binary form.
func (pkt *CountDownEnd) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *CountDownEnd) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 4 {
		return ErrInvalidPacketSize
	}
	return nil
...
// Serialize encodes the struct into its binary form.
func (pkt *GameLoaded) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *GameLoaded) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 4 {
		return ErrInvalidPacketSize
	}
	return nil
...
// Serialize encodes the struct into its binary form.
func (pkt *PlayerLoaded) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *PlayerLoaded) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *GameOver) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *GameOver) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 5 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *StartLag) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
	...
	for i := 0; i < len(pkt.Players); i++ {
		pkt.Players[i].SerializeContent(buf)
	}
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *StartLag) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 5 {
		return ErrInvalidPacketSize
	}
	...
	for i := 0; i < len(pkt.Players); i++ {
		pkt.Players[i].DeserializeContent(buf)
	}
...
func (lp *LagPlayer) SerializeContent(buf *protocol.Buffer) {
	buf.WriteUInt8(lp.PlayerID)
	buf.WriteUInt32(lp.LagDurationMS)
}

// DeserializeContent decodes the binary data generated by SerializeContent.
func (lp *LagPlayer) DeserializeContent(buf *protocol.Buffer) {
...
// Serialize encodes the struct into its binary form.
func (pkt *StopLag) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
	buf.WriteUInt8(PidStopLag)
	buf.WriteUInt16(9)

	pkt.LagPlayer.SerializeContent(buf)

	return nil
}

// Deserialize decodes the binary data generated by Serialize.
func (pkt *StopLag) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 9 {
		return ErrInvalidPacketSize
	}

	pkt.LagPlayer.DeserializeContent(buf)
	return nil
}
...
// Serialize encodes the struct into its binary form.
func (pkt *DropLaggers) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *DropLaggers) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 4 {
		return ErrInvalidPacketSize
	}
	return nil
...
// Serialize encodes the struct into its binary form.
func (pkt *GameAction) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *GameAction) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 8 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *TimeSlot) Serialize(buf *protocol.Buffer) error {
	var start = buf.Size()
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *TimeSlot) Deserialize(buf *protocol.Buffer) error {
	var pid, size = readPacketHeader(buf)
	if size < 6 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *TimeSlotAck) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *TimeSlotAck) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 9 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *Desync) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *Desync) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 14 {
		return ErrInvalidPacketSize
	}
...
func (pkt *Desync) SerializeContent(buf *protocol.Buffer) {
...
// DeserializeContent decodes the binary data generated by SerializeContent.
func (pkt *Desync) DeserializeContent(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *Message) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *Message) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 8 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *MessageRelay) Serialize(buf *protocol.Buffer) error {
	var start = buf.Size()
...
// Serialize encodes the struct into its binary form.
func (pkt *PeerMessage) Serialize(buf *protocol.Buffer) error {
	var start = buf.Size()
	if err := pkt.Message.Serialize(buf); err != nil {
		return err
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *SearchGame) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *SearchGame) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 16 {
		return ErrInvalidPacketSize
	}
...
// SerializeContent encodes the struct into its binary form.
func (gv *GameVersion) SerializeContent(buf *protocol.Buffer) {
	buf.WriteBEDString(gv.Product)
	buf.WriteUInt32(gv.Version)
}

// DeserializeContent decodes the binary data generated by SerializeContent.
func (gv *GameVersion) DeserializeContent(buf *protocol.Buffer) {
...
func (gs *GameSettings) SerializeContent(buf *protocol.Buffer) {
...
func (gs *GameSettings) DeserializeContent(buf *protocol.Buffer) error {
...
func (pkt *GameInfo) Serialize(buf *protocol.Buffer) error {
	...
	buf.WriteUInt8(0)
	pkt.GameSettings.SerializeContent(buf)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *GameInfo) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 45 {
		return ErrInvalidPacketSize
	}
	...
	if err = pkt.GameSettings.DeserializeContent(buf); err != nil {
		return err
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *CreateGame) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *CreateGame) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 16 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *RefreshGame) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *RefreshGame) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 16 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *DecreateGame) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *DecreateGame) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 8 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *PeerConnect) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *PeerConnect) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *PeerSet) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *PeerSet) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *MapCheck) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *MapCheck) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 41 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *StartDownload) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *StartDownload) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 9 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *MapState) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *MapState) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *MapPart) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *MapPart) Deserialize(buf *protocol.Buffer) error {
	var size = readPacketSize(buf)
	if size < 18 {
		return ErrInvalidPacketSize
	}
...
// Serialize encodes the struct into its binary form.
func (pkt *MapPartOK) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *MapPartOK) Deserialize(buf *protocol.Buffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *MapPartError) Serialize(buf *protocol.Buffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *MapPartError) Deserialize(buf *protocol.Buffer) error {
	if readPacketSize(buf) != 4 {
		return ErrInvalidPacketSize
	}
	return nil
