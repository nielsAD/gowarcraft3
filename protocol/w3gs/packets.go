...
func (pkt *SlotInfo) serialize(buf *protocol.Buffer) {
...
func (lp *LagPlayer) serialize(buf *protocol.Buffer) {
	buf.WriteUInt8(lp.PlayerID)
	buf.WriteUInt32(lp.LagDurationMS)
}

func (lp *LagPlayer) deserialize(buf *protocol.Buffer) {
...
// PeerSet implements the [0x3B] W3GS_PEER_SET packet (C -> C).
//
