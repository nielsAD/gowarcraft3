...
func (gs *GameSettings) SerializeContent(buf *protocol.Buffer, enc *Encoding) {
	...
	gs.GameSettings.SerializeContent(buf, &enc.Encoding)
}
...
func (gs *GameSettings) DeserializeContent(buf *protocol.Buffer, enc *Encoding) error {
	...
	if err := gs.GameSettings.DeserializeContent(buf, &enc.Encoding); err != nil {
		return err
	}
...
func (pkt *GetAdvListResp) Serialize(buf *protocol.Buffer, enc *Encoding) error {
	...
	if len(pkt.Games) == 0 {
		...
		for i := 0; i < len(pkt.Games); i++ {
			...
			buf.WriteUInt8(0)
			pkt.Games[i].GameSettings.SerializeContent(buf, enc)
		}
	}
...
func (pkt *GetAdvListResp) Deserialize(buf *protocol.Buffer, enc *Encoding) error {
	...
	for i := 0; i < len(pkt.Games); i++ {
		...
		if err = pkt.Games[i].GameSettings.DeserializeContent(buf, enc); err != nil {
			return err
		}
...
func (pkt *NotifyJoin) Serialize(buf *protocol.Buffer, enc *Encoding) error {
	...
	pkt.GameVersion.SerializeContent(buf, &enc.Encoding)
	buf.WriteCString(pkt.GameName)
	buf.WriteUInt8(0)
	return nil
}
...
func (pkt *NotifyJoin) Deserialize(buf *protocol.Buffer, enc *Encoding) error {
	...
	pkt.GameVersion.DeserializeContent(buf, &enc.Encoding)
...
func (pkt *AuthAccountChangePassResp) Serialize(buf *protocol.Buffer, enc *Encoding) error {
	var start = buf.Size()
	if err := pkt.AuthAccountLogonResp.Serialize(buf, enc); err != nil {
		return err
	}
...
func (pkt *AuthAccountChangePassReq) Serialize(buf *protocol.Buffer, enc *Encoding) error {
	var start = buf.Size()
	if err := pkt.AuthAccountLogonReq.Serialize(buf, enc); err != nil {
		return err
	}
	buf.WriteUInt8At(start+1, PidAuthAccountChange)
	return nil
...
func (pkt *AuthAccountChangePassProofResp) Serialize(buf *protocol.Buffer, enc *Encoding) error {
	var start = buf.Size()
	if err := pkt.AuthAccountLogonProofResp.Serialize(buf, enc); err != nil {
		return err
	}
