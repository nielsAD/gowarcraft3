...
func (pkt *UnknownPacket) MarshalBinary() (data []byte, err error) {
	return pkt.Blob, nil
}
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *PingFromHost) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *SlotInfoJoin) MarshalBinary() (data []byte, err error) {
	...
	// Set slot size
	buf.writeUInt16At(4, uint16(buf.size()-4))
...
func (pkt *SlotInfoJoin) UnmarshalBinary(data []byte) error {
	...
	if slotSize != 9+numSlots*9 || len(data) != 30+numSlots*9 {
		return errMalformedData
	}
...
func (sd *SlotData) write(buf *packetBuffer) {
	buf.writeUInt8(sd.PlayerID)
	buf.writeUInt8(sd.DownloadStatus)
	buf.writeUInt8(sd.SlotStatus)
	buf.writeBool(sd.Computer)
	buf.writeUInt8(sd.Team)
	buf.writeUInt8(sd.Color)
	buf.writeUInt8(sd.Race)
	buf.writeUInt8(sd.ComputerType)
	buf.writeUInt8(sd.Handicap)
}

func (sd *SlotData) read(buf *packetBuffer) {
	sd.PlayerID = buf.readUInt8()
	sd.DownloadStatus = buf.readUInt8()
	sd.SlotStatus = buf.readUInt8()
	sd.Computer = buf.readBool()
	sd.Team = buf.readUInt8()
	sd.Color = buf.readUInt8()
	sd.Race = buf.readUInt8()
	sd.ComputerType = buf.readUInt8()
	sd.Handicap = buf.readUInt8()
}
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *RejectJoin) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *PlayerInfo) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *PlayerLeft) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *PlayerLoaded) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *SlotInfo) MarshalBinary() (data []byte, err error) {
	var buf = packetBuffer{bytes: make([]byte, 0, 6+len(pkt.Slots)*9)}
	buf.writeUInt8(protocolsig)
	...
	buf.writeUInt16(uint16(len(pkt.Slots)))
	for i := 0; i < len(pkt.Slots); i++ {
		pkt.Slots[i].write(&buf)
	}
...
func (pkt *SlotInfo) UnmarshalBinary(data []byte) error {
	...
	var buf = packetBuffer{bytes: data[4:]}
	var numSlots = int(buf.readUInt16())

	if len(data) != 6+numSlots*9 {
		return errMalformedData
	}
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *CountDownStart) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *CountDownEnd) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *IncomingAction) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *ChatFromHost) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *StartLag) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *StopLag) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *LeaveAck) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *ReqJoin) MarshalBinary() (data []byte, err error) {
	var buf = packetBuffer{bytes: make([]byte, 0, 30+len(pkt.PlayerName))}
	buf.writeUInt8(protocolsig)
...
func (pkt *ReqJoin) UnmarshalBinary(data []byte) error {
	...
	if len(data) != 30+len(pkt.PlayerName) {
		return errMalformedData
	}
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *LeaveReq) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *GameLoadedSelf) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *OutgoingAction) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *OutgoingKeepAlive) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *ChatToHost) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *DropReq) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *SearchGame) MarshalBinary() (data []byte, err error) {
...
func (pkt *SearchGame) UnmarshalBinary(data []byte) error {
	...
	var buf = packetBuffer{bytes: data[4:]}
	pkt.TFT = string(buf.readBlob(4)) == gameW3XP
	pkt.Version = buf.readUInt32()
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *GameInfo) MarshalBinary() (data []byte, err error) {
	var buf = packetBuffer{bytes: make([]byte, 0, 41+len(pkt.GameName)+len(pkt.StatString))}
	buf.writeUInt8(protocolsig)
...
func (pkt *GameInfo) UnmarshalBinary(data []byte) error {
	...
	if len(data) < 41+len(pkt.GameName) {
		return errMalformedData
	}
	...
	if len(data) != 41+len(pkt.GameName)+len(pkt.StatString) {
		return errMalformedData
	}
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *CreateGame) MarshalBinary() (data []byte, err error) {
	var buf = packetBuffer{bytes: make([]byte, 0, 16)}
	buf.writeUInt8(protocolsig)
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *RefreshGame) MarshalBinary() (data []byte, err error) {
	var buf = packetBuffer{bytes: make([]byte, 0, 16)}
	buf.writeUInt8(protocolsig)
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *DecreateGame) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *PingFromOthers) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *PongToOthers) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *ClientInfo) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *MapCheck) MarshalBinary() (data []byte, err error) {
	var buf = packetBuffer{bytes: make([]byte, 0, 25+len(pkt.FilePath))}
	buf.writeUInt8(protocolsig)
	...
	buf.writeUInt32(pkt.FileSha1Hash)
...
func (pkt *MapCheck) UnmarshalBinary(data []byte) error {
	...
	if len(data) != 25+len(pkt.FilePath) {
		return errMalformedData
	}
	...
	pkt.FileSha1Hash = buf.readUInt32()
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *StartDownload) MarshalBinary() (data []byte, err error) {
	if pkt.PlayerID > 0 {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *MapSize) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *MapPart) MarshalBinary() (data []byte, err error) {
...
//    (UINT32) Chunk position in file
//
// NOTE: Order of RecipientID/SenderID is reversed in Ghost
//
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *MapPartOK) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *MapPartError) MarshalBinary() (data []byte, err error) {
...
// MarshalBinary encodes the struct into its binary form.
func (pkt *PongToHost) MarshalBinary() (data []byte, err error) {
