...
func (ca *ConnAddr) deserialize(buf *util.PacketBuffer) {
	buf.Skip(2)
...
func (pkt *Join) Deserialize(buf *util.PacketBuffer) error {
	...
	pkt.InternalAddr.deserialize(buf)
...
func (pkt *SlotInfoJoin) Deserialize(buf *util.PacketBuffer) error {
	...
	pkt.ExternalAddr.deserialize(buf)
...
// Serialize encodes the struct into its binary form.
func (pkt *ClientInfo) Serialize(buf *util.PacketBuffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *ClientInfo) Deserialize(buf *util.PacketBuffer) error {
...
// Serialize encodes the struct into its binary form.
func (pkt *MapSize) Serialize(buf *util.PacketBuffer) error {
	buf.WriteUInt8(ProtocolSig)
...
// Deserialize decodes the binary data generated by Serialize.
func (pkt *MapSize) Deserialize(buf *util.PacketBuffer) error {
